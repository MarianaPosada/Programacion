<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgenciaViajes.aspx.cs" Inherits="pSitioWEB_Programacion.ReglasNegocio.AgenciaViajes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="nav-justified">
        <tr>
            <td colspan="2" style="text-align: center; font-weight: 700; font-size: large">
                <br style="font-size: x-large" />
                <span style="font-size: x-large">AGENCIA DE VIAJES - VENTA PAQUETES TURÍSTICOS</span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" style="text-align: center; font-size: large">
                <asp:Button ID="btnCalcular" runat="server" Height="43px" Text="CALCULAR" Width="166px" OnClick="btnCalcular_Click" style="font-size: x-large" BackColor="Aqua" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
